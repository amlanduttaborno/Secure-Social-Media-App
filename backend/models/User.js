...
const userSchema = new mongoose.Schema({
  ...
  usernameMac: { type: String, required: true },
  usernameKeyVersion: { type: Number, required: true, default: 1 },
  emailEnc: { type: String, required: true },
  emailMac: { type: String, required: true },
  emailKeyVersion: { type: Number, required: true, default: 1 },
